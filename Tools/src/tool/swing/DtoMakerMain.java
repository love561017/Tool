...
//				g.drawString("增加註解方式: 在欄位後面加@", 500, 750);
		...
		this.dtoNam = new JTextField();
		this.dtoNam.setText("dtoNam");
		this.dtoNam.setBounds(80, 10, 100, 30);
		this.dtoNam.setFont(f);
		jp.add(this.dtoNam, "North");
		this.dtoNam.setColumns(10);
//		
	...
	class ListenerJava implements ActionListener {
		public void actionPerformed(ActionEvent e) {
			...
			try {
				...
				DtoMakerMain.this.txtSql.setText(dtoMaker.process(txtSql.getText(), dtoNam.getText(), Main.tableColumnsMap));
			} catch (Exception e1) {
				DtoMakerMain.this.txtSql.setText(e1.getMessage());
			}
		}
	}
